...
<head>
    ...
    print DIR_CSS."css/bootstrap.css\""?>/>
    <link rel="stylesheet" type="text/css" href=<?php
    print DIR_CSS."css/main-style.css\"";?>/>
    <link rel="stylesheet" type="text/css" href=<?php
    print DIR_CSS."css/news/news.css\""?>/>
    <?php
...
<header>
    <nav class="navbar navbar-default col-md-8 col-md-offset-2 row" role="navigation">
        <a class="navbar-brand" href="#"><img src=<?php print DIR_CSS."images/palette.png\"";?>></a>
